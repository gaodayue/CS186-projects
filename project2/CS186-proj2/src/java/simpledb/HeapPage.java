...
public class HeapPage implements Page {
    ...
    HeapPageId pid;
    TupleDesc td;
    byte header[];  // raw header bytes in this heap page
    Tuple tuples[]; // de-serialized tuples in this page, including nulls
    int numSlots;

    TransactionId lastDirtyTid;

    byte[] oldData; // clone of the original page from disk
    ...
    */
     ...
     * Used to <b>serialize</b> this page to disk.
     * <p>
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if (t.getRecordId().getPageId() != pid)
            throw new DbException("tuple not belong to this page");
        if (!isSlotUsed(slotNo))
            throw new DbException("tuple not on this page");

        tuples[slotNo] = null; // needed for NonEmptyTupleIterator to skip nulls
        // update page header
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        if (getNumEmptySlots() == 0)
            throw new DbException("no empty slot in this page");
        ...
        // put the new tuple into that slot
        tuples[slot] = t;
